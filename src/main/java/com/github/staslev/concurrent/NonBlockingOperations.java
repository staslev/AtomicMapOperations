...
public class NonBlockingOperations {
   ...
   */
  public interface Aggregator<TInput, TValue> extends Serializable {
  ...
  public interface Transformer<V> extends Serializable {
  ...
  public static class forMap {
    ...
    private static final AtomicMapOperationsForImmutableValues FOR_IMMUTABLE_VALUES =
            new AtomicMapOperationsForImmutableValues();
