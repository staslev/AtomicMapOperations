...
public class AtomicMapOperationsForImmutableValues {
  ...
  private <K, V> boolean atomicallyInsertNewEntry(final ConcurrentMap<K, V> map,
                                                  final K key,
                                                  final V previousValueOrNull,
                                                  final V nextValue) {
  ...
  private <K, V> boolean atomicallyUpdateExistingEntry(final ConcurrentMap<K, V> map,
                                                       final K key,
   ...
   */
  public <K, V, T> void putOrAggregate(final ConcurrentMap<K, V> map,
                                       final K key,
                                       final NonBlockingOperations.Aggregator<T, V> aggregator,
                                       T input) {
   ...
   */
  public <K, V, T> boolean aggregateIfPresent(final ConcurrentMap<K, V> map,
                                              final K key,
                                              final NonBlockingOperations.Aggregator<T, V> aggregator,
                                              T input) {
